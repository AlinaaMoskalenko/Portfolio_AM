...
*/
var aa=__webpack_require__(15),n=__webpack_require__(31),da=__webpack_require__(53);function ea(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var _CommentForm = __webpack_require__(411);

var _httpService = __webpack_require__(413);
    ...
    _createClass(CommentList, [{
        ...
        value: function render() {
            ...
            var commentList = this.props.comments.map(function (comment, i) {
                ...
                var dateString = date.getHours() + ':' + date.getMinutes() + ":" + date.getSeconds() + " " + MONTHS[date.getMonth()] + " " + date.getDate() + ", " + date.getFullYear();

                var deleteComment = function deleteComment() {
                    _this2.props.onDeleteItem(comment.id);
                };

                return React.createElement(
                    'div',
                    { key: i, className: 'comment', id: id },
                    React.createElement(
                        'div',
